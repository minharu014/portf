        ...
        <div className="bg-white relative z-0">
          ...
          >
            ...
            >
              ...
              backend solutions and some pretty web apps. I enjoy using React,
              JavaScript, Python+C#/Java, and TailwindCSS. <br />
              Every day, I explore the latest tech news to stay up-to-date and
              don't fall behind!
              <br />
