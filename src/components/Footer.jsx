...
import blackEmail from "../assets/me/blackEmail.png";
...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#060606] text-white py-12 relative z-0">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <div className="mt-8">
            <ShinyText
              text={`© ${new Date().getFullYear()} HT. All rights reserved.`}
              speed={1}
